  ...
  return (
    <Layout>
      <Wrap>
        ...
        <p>Updated at 2021-07-31</p>

        <p>
          Conundrum Quest (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Conundrum Quest.
        </p>
        <p>
          ...
          Conundrum Quest. By accessing or using our Service, you signify that
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Conundrum Quest, that is responsible for your
              information under this Privacy Policy.
            </li>
            <li>
              Country: where Conundrum Quest or the owners/founders of Conundrum
              Quest are based, in this case is Canada
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the Conundrum Quest Service to manage the relationships
              with your consumers or service users.
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Conundrum
              Quest and use the services.
            </li>
            <li>
            ...
            <li>
              ...
              Conundrum Quest or are under contract to perform a service on
            ...
            <li>
              Service: refers to the service provided by Conundrum Quest as
            ...
            <li>
              You: a person or entity that is registered with Conundrum Quest to
              use the Services.
            </li>
          </ul>
        </p>
        ...
        <h1>
          When does Conundrum Quest use end user information from third parties?
        </h1>
        <p>
          Conundrum Quest will collect End User Data necessary to provide the
          Conundrum Quest services to our customers.
        </p>
        <p>
        ...
        <h1>
          When does Conundrum Quest use customer information from third parties?
        </h1>
        <p>
          ...
          interest in becoming a Conundrum Quest customer, we receive
          information from a third party that provides automated fraud detection
          services to Conundrum Quest. We also occasionally collect information
        ...
        <p>
          Conundrum Quest will collect personal information that you submit to
        ...
        <p>
          ...
          Conundrum Quest to you and fulfill the purposes described in this
        ...
        <p>
          ...
          absolute security of any information you transmit to Conundrum Quest
        ...
        <p>
          Conundrum Quest is incorporated in Canada. Information collected via
        ...
        <h1>
          Is the information collected through the Conundrum Quest Service
          secure?
        </h1>
        <p>
        ...
        <p>
          ...
          information Conundrum Quest collects depend on your relationship with
          Conundrum Quest. Personnel may update or correct their information as
        ...
        <p>
          ...
          of the assets of Conundrum Quest or any of its Corporate Affiliates
          (as defined herein), or that portion of Conundrum Quest or any of its
        ...
        <h1>Governing Law</h1>
        <p>
          This Privacy Policy is governed by the laws of Canada without regard
        ...
        <p>
          By using Conundrum Quest or contacting us directly, you signify your
        ...
        <p>
          ...
          Conundrum Quest. We are not responsible for the content, accuracy or
        ...
        <p>
          ...
          decency, quality or any other aspect thereof. Conundrum Quest does not
        ...
        <p>
          ...
          requirements of GDPR. Conundrum Quest processes or stores all personal
